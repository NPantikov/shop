...
const ProductCard = (props) => {
  const { id, title, description, price = 0, imgSrc, category } = props;
  ...
  return (
    <article className="product-card">
      ...
      <div className="product-card__body">
        <Link className="product-card__title" to={href}>
          {title}
        </Link>
        <div className="product-card__description" title={description}>
          {description}
        </div>
      </div>
      {isExistInBasket && (
